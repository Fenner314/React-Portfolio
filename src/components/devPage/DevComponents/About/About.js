		...
		return (
			<div className="about-heading">
				...
				<p className="large-text about-subheading">
					I'm a front end developer and classically trained musician. I love
					creating new things, making things better, and finding creative
			...
			<div className="about-info">
				<div className="bio">
					<p>
						...
						learned to code through Codecademy courses and mentorship from a
						full stack developer. My love for coding was inspired by my passion
						for creating, and the skills I've developed throughout my life in
						music amplify my skills as a developer.
					</p>
				</div>
