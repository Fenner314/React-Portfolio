...
export default function About() {
	...
	const renderAboutHeading = () => {
		return (
			<div className='about-heading'>
				...
				<p className='large-text about-subheading'>
					I'm a self-taught front end developer with is also familiar with back
					end languages. I love creating new things, making things better, and
	...
	const renderAboutInfo = () => {
		return (
			<div className='about-info'>
				<div className='bio'>
					<p>
						I have two degrees in music, but I discovered my love for coding
						while finishing my master's degree and haven't looked back. I
						learned to code through Codecademy courses, YouTube videos, and
						mentorship from a full stack developer. My love for coding is
						inspired by my passion for creating, and the skills I've developed
						throughout my life in music amplify my skills as a developer.
					</p>
				</div>
				<div className='sources'>
					<p className='medium-text bold'>
						How does being a musician make me a better developer?
					</p>
					<Button
						width='200px'
						height='50px'
		...
		return (
			<div className='slider'>
				<Slider {...settings}>
					...
					<div className='language'>
						<i class='fab fa-node-js fa-4x'></i> <span>Node.js</span>
					</div>
					<div className='language'>
						<svg
							xmlns='http://www.w3.org/2000/svg'
	...
	return (
		...
		<section id='about' className='section'>
			...
			<div
				className={popupActive ? 'overlay-active' : 'overlay'}
				onClick={handlePopupChange}
			></div>
		</section>
		// </Parallax>
